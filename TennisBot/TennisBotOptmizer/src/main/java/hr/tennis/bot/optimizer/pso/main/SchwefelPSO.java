...
import hr.tennis.bot.optimizer.function.impl.SchwefelFunction;
...
import hr.tennis.bot.optimizer.pso.main.RastringPSO.Solution;
import hr.tennis.bot.optimizer.util.RandomUtil;
import hr.tennis.bot.util.ArrayUtil;

public class SchwefelPSO {
	...
	public static void main(String[] args) {
		...
		int dim = 2;
		double velIntervalPercent = 0.15;
		...
		final Function func = new SchwefelFunction(dim);
